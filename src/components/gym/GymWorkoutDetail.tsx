...
export function GymWorkoutDetail({ onBack }: GymWorkoutDetailProps) {
  const { exercises, timeline, toggleExercise } = useGymStore();
  const [selectedExerciseId, setSelectedExerciseId] = useState<string>(
    exercises[0]?.id || "ex-bench-press"
  );
  ...
  const isCurrentCompleted = activeExercise.completed;

  const handleToggleComplete = async () => {
    await toggleExercise(activeExercise.id);
  };
        ...
        <div className="workout-header-block">
          ...
          <div className="header-titles">
            ...
            <span className="workout-subtitle">
              Chest • Shoulders • Triceps &nbsp;|&nbsp; Discipline builds
              strength.
            </span>
          </div>
        </div>
          ...
          <div className="timeline-scroll-list">
            {timeline.map((item) => {
              ...
              const isCompleted = item.exerciseId
                ? exercises.find((e) => e.id === item.exerciseId)?.completed ??
                  item.completed
                : item.completed;
              ...
              return (
                <div
                  key={item.id}
                  className={`timeline-row-item type-${item.type} ${
                    isSelected ? "active" : ""
                ...
                >
                  ...
                  {isSelected && (
                    <span className="timeline-active-arrow">&gt;</span>
                  )}
                </div>
              );
            })}
          ...
          <div className="exercise-header-row">
            ...
            <button
              className={`mark-complete-btn ${
                isCurrentCompleted ? "is-completed" : ""
              }`}
            ...
            <div className="targeted-muscles-box">
              ...
              <div className="muscles-body-diagram">
                ...
                >
                  ...
                  />
                  <path
                    d="M20 55 C25 55 25 75 20 75 C15 75 15 55 20 55 Z"
                    fill="#eab308"
                    opacity="0.85"
                  />
                  <path
                    d="M80 55 C75 55 75 75 80 75 C85 75 85 55 80 55 Z"
                    fill="#eab308"
                    opacity="0.85"
                  />
                  <path
                    d="M35 65 C45 65 55 65 65 65 C62 90 38 90 35 65 Z"
                    fill="#261e17"
                  />
                  <path
                    d="M36 90 C42 90 44 125 38 125 C32 125 32 90 36 90 Z"
                    fill="#261e17"
                  />
                  <path
                    d="M64 90 C58 90 56 125 62 125 C68 125 68 90 64 90 Z"
                    fill="#261e17"
                  />
                </svg>
              </div>
          ...
          <div className="exercise-details-grid">
            ...
            <div className="info-card">
              ...
              <div className="rest-info-group">
                <span className="rest-icon">💧</span>
                <span className="rest-sub">
                  Drink water during breaks. Stay hydrated. Stay strong.
                </span>
              </div>
            </div>
